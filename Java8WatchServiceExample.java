...
public class Java8WatchServiceExample {
	...
	/* creates the watch service and registers the given directory */
	...
	/*
	 * Register the given directory and all its sub directories,with the watch
	 * service
	 */
	...
	public void processEvents() {
		while (true) {
			...
			for (WatchEvent<?> event : key.pollEvents()) {
				...
				//if directory is created register it and all its sub directories
